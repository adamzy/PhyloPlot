...
(function() {
  $(document).ready(function() {
    var clear, default_options_string, doplot, load_options, options, plotPhylogeny, reset_options, saveplot;
    options = {
      id: "",
      treestring: "",
      labelcolors: "",
...
<<<<<<< HEAD
      var a, b, bbox, color, drag, dragmove, edge_color, edge_scale, edge_width, edges, fontsize, fx, fy, get_text_size, height, i, j, label_color, label_fontsize, label_offset, labelcolors, labels, labelscales, line, n, nl, nodes, outheight, outwidth, pad, parse_input, parse_labelcolors, parse_labelscales, resolve, svg, tmp, tree, width, x, y, _edges, _i, _j, _k, _l, _labels, _len, _len1, _len2, _len3, _len4, _m, _ref, _ref1, _ref2, _ref3;
      _ref = options["default"], label_fontsize = _ref.label_fontsize, label_color = _ref.label_color, label_offset = _ref.label_offset, edge_width = _ref.edge_width, edge_color = _ref.edge_color, edge_scale = _ref.edge_scale;
=======
...
<<<<<<< HEAD
            var k, v, _ref1;
            _ref1 = e.split(":"), k = _ref1[0], v = _ref1[1];
=======
            var k, ref1, v;
...
<<<<<<< HEAD
        ...
        _ref1 = tmp[0][0].getBoundingClientRect(), width = _ref1.width, height = _ref1.height;
=======
...
<<<<<<< HEAD
      for (_i = 0, _len = nl.length; _i < _len; _i++) {
        n = nl[_i];
        if (!n.isRoot()) {
          _ref1 = n.loc, x = _ref1[0], y = _ref1[1];
          _ref2 = n.father.loc, fx = _ref2[0], fy = _ref2[1];
=======
...
<<<<<<< HEAD
            _ref3 = get_text_size(n.name, fontsize), width = _ref3[0], height = _ref3[1];
=======
...
<<<<<<< HEAD
      for (i = _j = 0, _len1 = labels.length; _j < _len1; i = ++_j) {
        a = labels[i];
        for (j = _k = 0, _len2 = labels.length; _k < _len2; j = ++_k) {
=======
...
<<<<<<< HEAD
      for (i = _l = 0, _len3 = labels.length; _l < _len3; i = ++_l) {
        a = labels[i];
        for (j = _m = 0, _len4 = labels.length; _m < _len4; j = ++_m) {
=======
...
>>>>>>> master
      ...
      _labels = svg.append("g").selectAll("text").data(labels).enter().append("text").attr("x", function(d) {
        return d.lx;
      }).attr("y", function(d) {
        return d.ly;
